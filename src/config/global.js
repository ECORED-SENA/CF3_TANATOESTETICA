export default {
  global: {
    componenteFormativo: 'Generalidades de la tanatoestética',
    descripcionCurso:
      'El presente componente va dirigido al cuidado estético del fallecido, que permite acomodar las facciones, reponer y/o adecuar la estructura ósea, restablecer tejido blando y realizar los procesos cosméticos que se consideren necesarios. Por ello, este componente tiene como propósito identificar la correcta aplicación de los protocolos estéticos para la presentación de la persona fallecida, siguiendo tanto los requerimientos de la familia como las técnicas de tanatoestética.',
