...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .bg--gray
      .row.justify-content-center.align-items-center
        .col-lg-4.position-relative.mb-4.mb-lg-0(data-aos="zoom-in")
          figure
            img(src="@/assets/curso/t4/img_4_01.png", alt="alt").m-auto
      ...
      .row.justify-content-center
        .col-auto.mb-5(data-aos="flip-right")
          .crd.crd--topLine.bg_topLine_01
            figure.mb-4
              img(src="@/assets/curso/t4/img_3_04.svg", alt="alt",style="width:90px;").m-auto
        ...
        .col-auto.mb-5(data-aos="flip-right")
          .crd.crd--topLine.bg_topLine_04
            figure.mb-4
              img(src="@/assets/curso/t4/img_3_05.svg", alt="alt",style="width:90px;").m-auto
        ...
        .col-auto.mb-5(data-aos="flip-right")
          .crd.crd--topLine.bg_topLine_03
            figure.mb-4
              img(src="@/assets/curso/t4/img_3_06.svg", alt="alt",style="width:90px;").m-auto
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-4.position-relative.mb-4.mb-lg-0(data-aos="zoom-in")
        figure
          img(src="@/assets/curso/t4/img_4_02.png", alt="alt").m-auto
    ...
    .row.justify-content-center.clr--bgGreenPale.mb-5
      ...
      .col-lg-4.position-relative(data-aos="zoom-in")
        figure
          img(src="@/assets/curso/t4/img_4_03.svg", alt="alt").m-auto.img--350
